...
function CashOnDeliveryOrderSuccess() {
  ...
  // Extract the nested order data correctly
  const data = location.state?.order?.order?.order;
      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="mt-2 sm:mt-3 text-sm sm:text-lg text-gray-600">
            ...
            {formatCurrency(order.totalPrice)} when your order arrives.
          </p>
          ...
          <div className="p-4 sm:p-6">
            <div className="space-y-3 sm:space-y-4">
              {order.orderItems?.map((item, index) => (
                ...
                >
                  <div className="relative bg-gray-200 border-2 border-dashed rounded-xl w-12 h-12 sm:w-16 sm:h-16 flex items-center justify-center overflow-hidden">
                    {item.image ? (
                      <img
                        src={item.image}
                        alt={item.name}
          ...
          <div className="mt-3 bg-yellow-50 border-l-4 border-yellow-400 p-3 rounded">
            <div className="flex items-start">
              ...
              <p className="text-yellow-700 text-left">
                You'll pay ₹{formatCurrency(order.totalPrice)} when your order
                arrives
              </p>
            </div>
          </div>
...
export default CashOnDeliveryOrderSuccess;
