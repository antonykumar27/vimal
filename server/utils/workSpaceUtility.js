...
//*******************************/
exports.createWorkspaceService = async (userId, body) => {
...
//*******************************/
exports.getAllWorkspacesUserIsMemberService = async (userId) => {
...
exports.getWorkspaceByIdService = async (workspaceId) => {
...
//*******************************/
exports.getWorkspaceMembersService = async (workspaceId) => {
  const members = await MemberModel.find({
    workspaceId,
  })
...
exports.getWorkspaceAnalyticsService = async (workspaceId) => {
...
exports.changeMemberRoleService = async (workspaceId, memberId, roleId) => {
  const workspace = await WorkspaceModel.findById(workspaceId);
  if (!workspace) {
    throw new NotFoundException("Workspace not found");
  }
...
// UPDATE WORKSPACE
//*******************************/
exports.updateWorkspaceByIdService = async (workspaceId, name, description) => {
  const workspace = await WorkspaceModel.findById(workspaceId);
  if (!workspace) {
    throw new NotFoundException("Workspace not found");
  }
...
exports.deleteWorkspaceService = async (workspaceId, userId) => {
